...
std::atomic<uint64_t> ProbeTiming::total_hash_lookup_ns{0};
std::atomic<uint64_t> ProbeTiming::total_chain_traverse_ns{0};
std::atomic<uint64_t> ProbeTiming::total_chain_traverse_count{0};
